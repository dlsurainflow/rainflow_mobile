    ...
    try {
       ...
       if (un != null){
         ...
         setBodyComponent(
          ...
          <List.Item  onPress = {()=> props.navigation.navigate("Account Info")} titleStyle = {{fontSize: 15}} style = {styles.listItem} descriptionStyle = {{fontSize: 12}} title="Account Information" description="Change your password"/>
